...
const componentCheckboxesWithTextField = {
...
const components = [componentCheckboxesWithTextField, componentTextField, componentMultilineTextField,
  {
        ...
        items: [
          {
            text: 'Sole trader',
            value: 'soleTrader',
            conditionalHtml: '<p class="govuk-body">Conditions apply...</p>'
          },
